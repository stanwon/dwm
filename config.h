...
static const char *fonts[]          = { "monospace:size=18", "NotoColorEmoji:pixelsize=18:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	// { MODKEY|ShiftMask|ControlMask, XK_d,      setlayout,      {.v = &layouts[9]} },
